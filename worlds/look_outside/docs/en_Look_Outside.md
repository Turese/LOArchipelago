...
Player can decide if the player character start with both arms, left arm, right arm, or with no arms at all. The arms they didn't start with will be available as item drops.
